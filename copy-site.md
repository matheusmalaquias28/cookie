# Copy completa — Landing Page Cookie Lab

> Documento com toda a copy da página de vendas, na ordem em que aparece no site. Os carrosséis estão descritos com seu conteúdo. Formato pensado para análise por IA (ChatGPT).

---

## 0. Metadados da página (SEO)

- **Title:** Cookie Lab | 100 Receitas de Cookies para Renda Extra
- **Meta description:** Aprenda a produzir cookies premium, mesmo começando do zero, e descubra como vender um produto que as pessoas realmente querem comprar. Acesso imediato.
- **OG description:** 100 receitas de cookies validadas, testadas e aprovadas para transformar sua cozinha em uma nova fonte de renda.

## 1. Barra de oferta (topo, fundo vermelho/brand)

> OFERTA ESPECIAL DISPONÍVEL SOMENTE HOJE {data de hoje} | TERMINA EM {contagem regressiva HH:MM:SS até meia-noite}

*(A data é dinâmica — sempre o dia atual. O countdown zera à meia-noite local.)*

## 2. CTA fixo no mobile (sticky, rodapé da tela)

Botão flutuante que aparece após o usuário rolar além da hero:
...
**Card compacto (roxo, estático):**
> 🧮 FAÇA AS CONTAS *(bem pequeno, em cima)*
...
**Prova social (avatares):** 5 fotos de rostos em círculo +
> Mais de 2.000 aluno(a)s

---

## 4. Carrossel de depoimentos (1ª aparição)

**[CARROSSEL]** — Marquee horizontal em loop automático com **7 prints de depoimentos de alunas**: 4 conversas de WhatsApp (feedback-1 a 4) + 3 stories do Instagram (feedback-5 a 7). Cerca de 1,5 imagem visível por vez.
...
**[CARROSSEL]** — Marquee horizontal em loop com **8 fichas A4 do material** (imagens: entregavel-1 a entregavel-8), mostrando páginas do e-book/receitas. Alt: "Ficha do material Cookie Lab".

---

## 6. Seção "Por que vender Cookies?" (fundo brand)

**H2:**
> Por que vender Cookies?🍪

**8 cards brancos com check:**
- Baixo investimento
- Alta procura
- Fácil de aprender
...
## 7. Seção "Oportunidade" (fundo preto)

**H2:**
> Você já deve ter visto alguém vendendo Cookies...

**Corpo:**
> Mas a verdade é que ainda são poucas as pessoas aproveitando essa **oportunidade.**
>
> Enquanto muita gente ainda nem percebeu essa tendência, quem começa agora pode conquistar seus primeiros clientes antes que o mercado fique cheio.
>
> Você provavelmente já viu isso acontecer antes...

**Destaques (fonte grande):**
- Morango do Amor 🍓
- Bolo de Pote 🎂
- Fatia de Bolo 🍰
- Copo da Felicidade 🥤
...
## 8. Aviso de urgência (fundo vermelho/alerta)
...
**Corpo:**
> Morango do Amor, Bolo de Pote, Copo da Felicidade: todos venderam **muito** no Brasil inteiro, e quem entrou cedo faturou mais.
>
> A hora de sair na frente e vender muito é **agora**, enquanto os Cookies Premium ainda estão começando.
...
## 9. Seção "Faça as contas" (animada, fundo branco)
...
**Timeline visual (cards com setas para baixo):**
1. 🍪 Cookie Premium — **R$14**
2. 10 vendidos por dia — **R$140**
3. 20 dias — **R$2.800** em vendas* 📈

**Disclaimer:**
> *Exemplo ilustrativo. Os resultados variam conforme preço de venda, custos, demanda da sua região e dedicação ao negócio.

---

## 9b. Seção "Antes x Depois" (comparativo)

**H2:**
> "Mas fazer Cookies é fácil, por que eu deveria comprar?"
...
## 10. Seção "Ideal para você"

**H2:**
> Ideal para você que deseja:

**6 cards (fundo brand, texto branco, com check):**
...
**[CARROSSEL]** — repetição do carrossel de materiais (mesmas 8 fichas A4 do item 5).

---

## 11. Oferta principal (card escuro)
...
**H3 (dentro do card escuro):**
> 100 Receitas de Cookies para transformar sua cozinha em uma nova **fonte de renda.**
...
## 12. Seção de Bônus (fundo brand)

**H2:**
> 🎁 Além das 100 receitas, ao adquirir o Plano Completo você vai levar 4 SUPER BÔNUS

**Bônus 1 — Guia de Precificação para venda**
> Aprenda a definir o preço certo para vender com confiança e lucrar em cada cookie.
> Valor: ~~R$12,90~~ **GRÁTIS**

**Bônus 2 — Cálculo de Custos e Margem de lucro**
> Descubra exatamente quanto custa produzir cada cookie e quanto sobra de lucro em cada venda.
> Valor: ~~R$19,90~~ **GRÁTIS**

**Bônus 3 — Modelos de Embalagens para Valorizar o Produto**
> Embalagens prontas e inspirações que deixam seus cookies mais profissionais e aumentam o valor percebido.
> Valor: ~~R$49,90~~ **GRÁTIS**

**Bônus 4 — Como Conseguir e Fidelizar os Primeiros Clientes**
> Estratégias simples para conquistar seus primeiros compradores e fazer com que eles voltem a comprar.
> Valor: ~~R$12,90~~ **GRÁTIS**

**Em cada card de bônus:**
> BÔNUS INCLUSO APENAS NO PLANO COMPLETO

---

## 13. Carrossel de depoimentos (2ª aparição)

**[CARROSSEL]** — mesmo carrossel de 7 depoimentos (WhatsApp + stories do Instagram) do item 4.

---

## 14. Planos / Preços

**Badge/pill:** ⏰ OFERTA VÁLIDA POR TEMPO LIMITADO
...
- **Downsell reverso (texto abaixo do botão):**
  > AINDA DÁ TEMPO DE LEVAR A MELHOR OPÇÃO! Leve mais e pague menos, 97% escolhem a nossa SUPER OFERTA!
- Seta apontando para o Plano Completo (mobile).

### Plano Completo (card escuro — MAIS VENDIDO)
- **Badge/pill:** ⚡MAIS VENDIDO
...
## 15. Garantia (fundo azul-marinho)

**Imagem:** selo de garantia de 7 dias.
...
>
> Oferecemos 7 dias de garantia total para você testar o material. Se decidir que não é para você, basta cancelar a compra e devolveremos todo o valor pago, sem complicação.
>
> Precisa de ajuda? Entre em contato conosco:

**Botão de contato:** contato@acookielab.com

---

## 16. Depoimentos (3ª aparição)

**Avatares** + "Mais de 2.000 aluno(a)s"

**H2:**
> Veja os depoimentos dos nossos clientes!

**[CARROSSEL]** — mesmo carrossel de 7 depoimentos (WhatsApp + stories do Instagram).

---

## 17. Como funciona o acesso (fundo brand)
...
**4 cards:**
1. 🛒 **Passo 1** — Você finaliza a compra de forma segura.
2. 📱 **Passo 2** — Receba o seu acesso imediatamente em seu email. Você pode acessar no seu celular, computador e tablet, em qualquer lugar do planeta!
3. 📁 **Passo 3** — Baixe e visualize todos os arquivos.
4. 🍪 **Passo 4** — Comece a produzir seus Cookies. Em caso de dúvidas basta chamar nosso suporte.
...
8. **Posso assistir pelo celular?** — Sim, o material funciona em celular, computador e tablet.
9. **E se eu não gostar do material?** — Você tem 7 dias de garantia total. Basta pedir o reembolso e devolvemos todo o valor pago.
...
> Copyright {ano atual} - Todos os direitos reservados.
>
> Contato: contato@acookielab.com
>
> Este site não possui qualquer vínculo com Facebook, Google ou qualquer outra plataforma mencionada. Todos os direitos da obra "Cookie Lab" são reservados ao seu autor. A reprodução não autorizada, total ou parcial, por qualquer meio, constitui violação de direitos autorais e pode resultar em sanções civis e criminais, de acordo com a legislação aplicável.

---

## Resumo dos CTAs (todos levam ao card do Plano Completo, exceto os de checkout)
...
| Passo a passo | QUERO ACESSAR AGORA! |
